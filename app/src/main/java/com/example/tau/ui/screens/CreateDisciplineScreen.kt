...
@Composable
fun CreateDisciplineScreen(modifier: Modifier = Modifier, onBackClick: () -> Unit, onSaveClick: () -> Unit) {
    ...
    Scaffold(
        ...
        topBar = {
            NavTopBar(
                title = Strings.PAGE_TITLE_CREATE_DISCIPLINE,
            ...
            AlertDialog(
                                ...
                                colorRow.forEach { (colorName, colorValue) ->
                                    Box(
                                        modifier = Modifier
                                            ...
                                            .background(colorValue, RoundedCornerShape(16.dp)),
                ...
                confirmButton = {
                    TextButton(
                        ...
                        Text(Strings.DIALOG_CONFIRM, color = Color.White)
                    }
                },
                dismissButton = {
                    TextButton(
                        ...
                        Text(Strings.DIALOG_DISMISS, color = Color.White)
                    }
                }
            )
        }
